...
$config = TypeScriptTransformerConfig::create()
  ...
  ->autoDiscoverTypes(__DIR__ . '/../lib')
  ->autoDiscoverExclude(__DIR__ . '/../lib/Database/Doctrine/ORM/Proxies')
  // list of transformers
  ->transformers([
    Transformers\MyclabsEnumTransformer::class,
    DevScripts\ConstantsTransformer::class,
    Transformers\DtoTransformer::class,
  ])
  // file where TypeScript type definitions will be written
  ->outputFile(__DIR__ . '/../build/ts-types/php-types.d.ts');

$types = TypeScriptTransformer::create($config)->transform();

/** @var TransformedType $type */
foreach ($types as $class => $type) {
  echo $class . ' -> ' . $type->getTypeScriptName() . PHP_EOL;
}
