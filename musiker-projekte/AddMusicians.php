<?php  
  ...
  echo "<h3>Besetzung &auml;ndern f&uuml;r Projekt $Projekt</h3>";
  echo '<h4>F&uuml;r die aktuelle Teilnehmerliste bitte die Buttons "... Display for ... "
...
Fundus mit aufgenommen (<A HREF="hinzufuegen.html" target="_blank">Anleitung</A>)</H4>';
 ...
 */
  ...
  // Sorting field(s)
  $opts['sort_field'] = array('Instrumente');
...
//  $opts['language'] = $_SERVER['HTTP_ACCEPT_LANGUAGE'] . '-UTF8';
  ...
  */
  ...
  $opts['filters'] = "(SELECT COUNT(*) FROM `Besetzungen` WHERE MusikerId = PMEtable0.Id AND ProjektId = $ProjektId) = 0";
  ...
  */
  ...
  $opts['fdd']['Hinzufuegen']['URL'] = "ProjektBesetzung.php?Projekt=$Projekt&ProjektId=$ProjektId&MusikerId=\$key&Action=AddOneMusician";
