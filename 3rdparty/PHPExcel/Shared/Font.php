...
class PHPExcel_Shared_Font
{
	 ...
	 * @var string
	 */
	private static $autoSizeMethod = self::AUTOSIZE_METHOD_EXACT;
	...
	public static function getTextWidthPixelsExact($text, PHPExcel_Style_Font $font, $rotation = 0) {
		...
		$size = intval($font->getSize() * 72.0 / 200.0);
		$textBox = imagettfbbox(1, $rotation, $fontFile, $text);
	...
	public static function getTextWidthPixelsApprox($columnText, PHPExcel_Style_Font $font = null, $rotation = 0)
	{
		...
		switch ($fontName) {
			...
			case 'Arial':
				...
				$columnWidth = (7.0 * PHPExcel_Shared_String::CountCharacters($columnText));
				$columnWidth = intval($columnWidth * $fontSize / 10.0); // extrapolate from font size
				break;
