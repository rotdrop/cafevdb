    ...
    function getHtml() {
        ...
        tinymce.each(fullSmileysList, function (row) {
            ...
            tinymce.each(row, function (icon) {
                smileysHtml += '<td><a href="#" data-shortcut="' + icon.shortcut + '" data-mce-url="' + icon.url + '" tabindex="-1" title="' + icon.title + '"><img src="' +
    ...
    editor.addButton('smileys', {
        ...
        panel: {
            ...
            onclick: function (e) {
                ...
                if (linkElm) {
                    editor.insertContent('<img src="' + linkElm.getAttribute('data-mce-url') + '" title="' + linkElm.getAttribute('title') + '" alt="' + linkElm.getAttribute('data-shortcut') + '" />');
                    this.hide();
                }
            }
        },
