    ...
    if ($this->Sender != '' and !ini_get('safe_mode')) {
      ...
      if ($this->SingleTo === true && count($toArr) > 1) {
        foreach ($toArr as $key => $val) {
          echo htmlspecialchars("$rt = @mail($val, $this->EncodeHeader($this->SecureHeader($this->Subject)), $body, $header, $params)");
        ...
        echo htmlspecialchars("$rt = @mail($to, $this->EncodeHeader($this->SecureHeader($this->Subject)), $body, $header, $params)");
