...
(function(window, $, CAFEVDB, undefined) {
  ...
  Location.popupId = "locationPopup";

  Location.googlePopup = function(latlng, location, popupId, position) {
    var self = this;
	...
	if (location == '') {
	  ...
	  location = t('cafevdb', 'Browser determined position')+'<br/>'+googlesearch;
	} else {
  ...
  Location.googleLocation = function(location, popupId, position) {
    var self = this;
    if (typeof popupId === 'undefined') {
	...
	var alerttext;
	if (location) {
	  alerttext = t('cafevdb', 'Location not found:')+' '+location;
	} else {
	  alerttext = t('cafevdb', 'No location specified.');
	}
	OC.dialogs.alert(alerttext, t('cafevdb', 'Unknown location'));
