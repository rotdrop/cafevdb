...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
delete (preset as any).globals['ts-jest'];
// eslint-disable-next-line @typescript-eslint/no-explicit-any
...
const config: Config = deepmerge(
  preset,
  {
    ...
    // cacheDirectory: "/tmp/.private/claus/jest_rs",
    ...
    coverageDirectory: './build/artifacts/jest/coverage',
    ...
    testEnvironment: './tests/jest/FixJSDOMEnvironment.ts',
    ...
    testMatch: [
      //   //   "**/__tests__/**/*.?([mc])[jt]s?(x)",
      //   '**/?(*.)+(spec|test).?([mc])[jt]s?(x)',
      //   '**/tests/jest/**/?(*.)+(spec|test).?([mc])[jt]s?(x)',
      //   '/tests/jest/',
