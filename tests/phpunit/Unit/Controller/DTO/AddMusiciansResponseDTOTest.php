...
use OCA\CAFEVDB\Controller\DTO\AddMusiciansResponse as TestedDTO;

/** Consistency test for AddMusiciansResponse DTO. */
#[Attributes\CoversClass(TestedDTO::class)]
class AddMusiciansResponseDTOTest extends TestCase
{
