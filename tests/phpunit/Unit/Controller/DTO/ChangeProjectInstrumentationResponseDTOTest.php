...
use OCA\CAFEVDB\Controller\DTO\ChangeProjectInstrumentationResponse as TestedDTO;

/** Consistency test for ChangeProjectInstrumentationResponse DTO. */
#[Attributes\CoversClass(TestedDTO::class)]
class ChangeProjectInstrumentationResponseDTOTest extends TestCase
{
