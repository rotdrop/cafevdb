...
use OCA\CAFEVDB\Controller\DTO\AutocompleteGnuCashAccountsResponse as TestedDTO;
use OCA\CAFEVDB\Controller\DTO\GnuCashAccountsAutocompleteData;
...
#[Attributes\CoversClass(GnuCashAccountsAutocompleteData::class)]
class AutocompleteGnuCashAccountsResponseDTOTest extends TestCase
{
  ...
  public function setup(): void
  {
    $this->dto = new TestedDTO(
      projectName: 'a name',
      accounts: GnuCashAccountsAutocompleteData::fromArray([
