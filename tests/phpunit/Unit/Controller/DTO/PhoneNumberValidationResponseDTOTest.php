...
use OCA\CAFEVDB\Controller\DTO\PhoneNumberValidationResponse as TestedDTO;

/** Consistency test for ValidatePhoneResponse DTO. */
#[Attributes\CoversClass(TestedDTO::class)]
class PhoneNumberValidationResponseDTOTest extends TestCase
{
  ...
  public function setup(): void
  {
    $this->dto = new TestedDTO(
      ...
      mobileMeta: 'a string',
      fixedLinePhone: 'a string',
      fixedLineMeta: 'a string',
    );
  }
}
