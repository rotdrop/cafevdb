...
use OCA\CAFEVDB\Controller\DTO\EmailValidationResponse as TestedDTO;

/** Consistency test for ValidatePhoneResponse DTO. */
#[Attributes\CoversClass(TestedDTO::class)]
class EmailValidationResponseDTOTest extends TestCase
{
  ...
  public function testDefaults(): void
  {
    ...
    $this->assertEquals([], $this->dto->details);
  }
}
