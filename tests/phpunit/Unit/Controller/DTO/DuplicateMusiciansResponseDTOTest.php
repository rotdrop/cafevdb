...
use OCA\CAFEVDB\Controller\DTO\DuplicateMusiciansResponse as TestedDTO;

/** Consistency test for ValidatePhoneResponse DTO. */
#[Attributes\CoversClass(TestedDTO::class)]
class DuplicateMusiciansResponseDTOTest extends TestCase
{
  ...
  public function setup(): void
  {
    $this->dto = new TestedDTO(
      messages: [ 'A Message' ],
      duplicates: [], // complicated stuff already testing in DuplicateMusicianDTOTest
    );
  }
}
