...
use OCA\CAFEVDB\EmailForm\EnumMemberSubstitutionKey as TranslatableEnum;
...
class EnumMemberSubstitutionKeyTest extends TestCase
{
  ...
  public function testAllValuesAreTranslated(): void
  {
    ...
    foreach ($array as $case => $value) {
      ...
      if (!in_array($value, self::L10N_EXCEPTIONS)) {
