...
/** Test aspects of the InstrumentInsurances page renderer. */
...
class InstrumentInsurancesTest extends TestCase
{
  ...
  private PageRenderer\InstrumentInsurances $renderer;
  ...
  public function setup(): void
  {
    ...
    // pretend that this (only) project is also the club-members project
    $configService->setConfigValue(ConfigConstants::CLUB_MEMBER_PROJECT_ID_KEY, self::$projectId);

    $this->renderer = new PageRenderer\InstrumentInsurances(
      configService: $configService,
      entityManager: $this->entityManager,
