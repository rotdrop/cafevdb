...
/** Test aspects of the InstrumentFamilies page renderer. */
...
#[Attributes\CoversClass(\OCA\CAFEVDB\Database\Doctrine\ORM\Repositories\InstrumentFamiliesRepository::class)]
...
class InstrumentFamiliesTest extends TestCase
{
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\InstrumentFamilies(
