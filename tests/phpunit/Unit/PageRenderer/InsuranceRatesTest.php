...
/** Test aspects of the InsuranceRates page renderer. */
...
class InsuranceRatesTest extends TestCase
{
  use \OCA\CAFEVDB\Tests\Unit\Maintenance\Migrations\SetupMigrationTrait;
  ...
  private PageRenderer\InsuranceRates $renderer;
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\InsuranceRates(
