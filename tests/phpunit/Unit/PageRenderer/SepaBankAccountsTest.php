...
/** Test aspects of the SepaBankAccounts page renderer. */
...
#[Attributes\UsesClass(\OCA\CAFEVDB\Service\Finance\ManuallyGeneratedReceivablesGenerator::class)]
...
class SepaBankAccountsTest extends TestCase
{
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\SepaBankAccounts(
      configService: $configService,
      entityManager: $this->entityManager,
