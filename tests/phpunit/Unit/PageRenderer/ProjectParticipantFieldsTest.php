...
class ProjectParticipantFieldsTest extends TestCase
{
  use \OCA\CAFEVDB\Tests\Unit\Maintenance\Migrations\SetupMigrationTrait;
  ...
  private PageRenderer\ProjectParticipantFields $renderer;
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\ProjectParticipantFields(
      ...
      //
      fuzzyInput: $appContainer->get(FuzzyInputService::class),
      instrumentationService: $appContainer->get(InstrumentationService::class),
  ...
  {
    $this->postData[PersistentCGIKeys::TEMPLATE] = PageRenderer\ProjectPayments::TEMPLATE;
    ob_start();
    try {
