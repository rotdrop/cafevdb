...
/** Test aspects of the Invoices page renderer. */
...
class InvoicesTest extends TestCase
{
  ...
  private PageRenderer\Invoices $renderer;
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\Invoices(
      configService: $configService,
      entityManager: $this->entityManager,
      ...
      //
      databaseStorageUtil: $appContainer->get(DatabaseStorageUtil::class),
      financeService: $appContainer->get(FinanceService::class),
      orgaRolesService: $appContainer->get(OrganizationalRolesService::class),
      participantFieldsService: $participantFieldsService,
  ...
  {
    $this->postData[PersistentCGIKeys::TEMPLATE] = PageRenderer\Invoices::TEMPLATE;
    ob_start();
    try {
