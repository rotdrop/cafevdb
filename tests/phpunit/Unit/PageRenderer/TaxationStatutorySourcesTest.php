...
/** Test aspects of the TaxationStatutorySources page renderer. */
...
class TaxationStatutorySourcesTest extends TestCase
{
  use \OCA\CAFEVDB\Tests\Unit\Maintenance\Migrations\SetupMigrationTrait;
  ...
  private PageRenderer\TaxationStatutorySources $renderer;
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\TaxationStatutorySources(
