...
/** Test aspects of the ProjectInstrumentationNumbers page renderer. */
...
class ProjectInstrumentationNumbersTest extends TestCase
{
  use \OCA\CAFEVDB\Tests\Unit\Maintenance\Migrations\SetupMigrationTrait;
  ...
  private PageRenderer\ProjectInstrumentationNumbers $renderer;
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\ProjectInstrumentationNumbers(
