...
/** Test aspects of the AddMusicians page renderer. */
...
class AddMusiciansTest extends TestCase
{
  ...
  private PageRenderer\AddMusicians $renderer;
  ...
  public function setup(): void
  {
    ...
    $this->renderer = new PageRenderer\AddMusicians(
