...
/**
 * Just used in order to instantiate a trait for a test. Note that in this
 * case an anonymous class does not work.
 */
class TestAppNameTraitClass
{
  use AppNameTrait {
    AppNameTrait::getAppInfoAppName as public;
  }
}
...
class AppNameTraitTest extends TestCase
{
  ...
  {
    $this->assertNotNull(TestAppNameTraitClass::getAppInfoAppName(__DIR__));
  }
}
