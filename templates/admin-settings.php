<form id="cafevdbkey">
  <fieldset class="personalblock">
    ...
    <div id="cafevdbkey">
      ...
      <input id="cafevdbkeybutton" type="submit" value="<?php echo $l->t('Change Encryption Key');?>" />
    </div>
    <div id="cafevdbgeneral">
    ...
    <div id="cafevdbpass">
      ...
      <input id="cafevdbpassbutton" type="submit" value="<?php echo $l->t('Change Database Password');?>" />
    </div>
  </fieldset>
</form>
