...
import {
  ...
  PROJECT_POPUP,
  PUSH_BUSY_STATE,
  SEPA_BULK_TRANSACTION_ACTIONS,
  SEPA_BULK_TRANSACTION_POPUP,
  SET_BUSY_FLAG,
  SET_DEBUG_MODES,
...
declare module '@rotdrop/async-nextcloud-event-bus' {
  ...
  export interface EventArgs {
    ...
    [INVOICE_ACTIONS]: { invoiceId: number, open: boolean, x?: number, y?: number },
    [PROJECT_ACTIONS]: { projectId: number, open: boolean, x?: number, y?: number },
    [SEPA_BULK_TRANSACTION_ACTIONS]: { bulkTransactionId: number, open: boolean, x?: number, y?: number },
    [INVOICE_POPUP]: { invoiceId: Number, projectId: number, projectName: string },
    [SEPA_BULK_TRANSACTION_POPUP]: { bulkTransactionId: Number, projectId: number, projectName: string },
    [PROJECT_EVENTS_LISTING]: { projectName: string },
    [PROJECT_POPUP]: { projectId: number, projectName: string },
