...
export const INVOICE_POPUP = appEventName('invoice-popup');
export const INVOICE_ACTIONS = appEventName('invoice-actions');
...
export const SEPA_BULK_TRANSACTION_ACTIONS = appEventName('sepa-bulk-transaction-actions');
export const SEPA_BULK_TRANSACTION_POPUP = appEventName('sepa-bulk-transaction-popup');
