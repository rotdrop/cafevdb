<!--
 ...
 - @copyright 2022, 2023, 2024, 2024 Claus-Justus Heine <himself@claus-justus-heine.de>
...
<script>
import { NcHighlight as Highlight } from '@nextcloud/vue'
...
export default {
  ...
  computed: {
     ...
     */
    tooltip() {
      return this.userInfoPopup(this.option)
    },
  },
}
</script>
