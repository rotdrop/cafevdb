 ...
 * @copyright 2011-2013, 2021-2022, 2024-2025 Claus-Justus Heine <himself@claus-justus-heine.de>
...
function defaultDoneCallback(file: UploadFile, index: number|string|symbol, $container:JQuery) {
  file.status = 'new';
  // file.index = index;
