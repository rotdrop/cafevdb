...
use OCA\CAFEVDB\Controller\DTO\InsuranceBrokerValidationResponse as TestedDTO;

/** Consistency test for ValidatePhoneResponse DTO. */
#[Attributes\CoversClass(TestedDTO::class)]
class InsuranceBrokerValidationResponseDTOTest extends TestCase
{
  ...
  public function setup(): void
  {
    $this->dto = new TestedDTO(
      ...
      brokerAddress: 'BROKER_ADDRESS_STRING',
    );
  }
}
