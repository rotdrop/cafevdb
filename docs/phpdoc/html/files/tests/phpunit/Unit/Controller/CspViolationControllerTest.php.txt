...
/** Test aspects of the CspViolationController. */
#[Attributes\CoversClass(Controller\CspViolationController::class)]
#[Attributes\UsesClass(\OCA\CAFEVDB\Service\L10N\L10NFactory::class)]
#[Attributes\UsesClass(\OCA\CAFEVDB\Service\Registration::class)]
#[Attributes\UsesClass(\OCA\CAFEVDB\Toolkit\AppInfo\AbstractApplication::class)]
class CspViolationControllerTest extends TestCase
{
  use TestRoutesAreDefinedTrait;

  private const CONTROLLER_CLASS = Controller\CspViolationController::class;
  ...
  private Controller\CspViolationController $controller;
  ...
  public function setup(): void
  {
    ...
    $this->controller = new Controller\CspViolationController(
      appName: $this->mockProvider->appName,
      request: $request,
      config: $this->mockProvider->getCloudConfig(),
