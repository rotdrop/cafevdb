...
class RecipientsFilterCssClasses
{
  ...
  public const NOT_PROJECT_MODE = 'not-project-mode';
  public const ONLY_PROJECT_MODE = 'only-project-mode';
  public const PROJECT_MAILING_LIST = RecipientsFilter::PROJECT_MAILING_LIST_KEY;
  public const PROJECT_MODE = 'project-mode';
  public const PROJECT_MODE_OFF = 'project-mode-off';
}
