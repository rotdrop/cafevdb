...
class MailingListsService
{
   ...
   * additional query is needed to retrieve the list-id from the server.
   *
   * @param null|string $displayName If given the display name of the list. If
   * \null the display name remains unchanged.
   *
   ...
   * @return void
   */
  public function configureAnnouncementsList(
    string $listId,
    ...
    if ($displayName !== null) {
      ...
      $config['subject_prefix'] = '[' . $displayName . ']';
    }
