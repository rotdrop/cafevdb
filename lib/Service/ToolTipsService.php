...
invited to have a look, but please do not change anything unless you know what your are doing. Thanks!'),
      ...
      'page-renderer' => [
        ...
        'musicians' => [
          'avatar' => $this->l->t('An optional avatar image provided by the person itself. This is part of the public self-expression of the respective user and thus read-only and only provided here for reference. Avatar images are only availabe for persons with an active cloud account.'),
