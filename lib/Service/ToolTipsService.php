...
clicking the "recover" button to the left of each deleted entry.'),
          ...
          'definition' => [
            'multiplicity' => [
              'lock' => $this->l->t('Changing the multiplicity of an extra-field after per-participant data has already been recorded is dangerous and may result in data-loss. Therefore changing the multiplicity is pro-forma disabled in this case and the control for changing the multiplicity has to be explicitly enable by the user.

Please be prepared that chaning the multiplicity may still fail. If you insist
on changing the multiplicity then the app will try to cope with some easy
cases and for example transfer multiple choice data to plain text fields,
however, this is an irreversible operation.'),
            ],
          ],
