...
the individual table views.'),
      ...
      'templates' => [
        'navigation' => [
          'name' => [
            PageRenderer\AllMusicians::TEMPLATE => self::t('Display all Musicians'),
            PageRenderer\Blog::TEMPLATE => self::t('Frontpage Blog'),
            PageRenderer\DonationReceipts::TEMPLATE => self::t('Donation Receipts'),
            PageRenderer\InstrumentFamilies::TEMPLATE => self::t('Instrument Families'),
            PageRenderer\InstrumentInsurances::TEMPLATE => self::t('Insurances'),
            ...
            PageRenderer\Invoices::TEMPLATE => self::t('Invoicing'),
            ...
            PageRenderer\ProjectParticipants::TEMPLATE => self::t('Participants'),
            PageRenderer\ProjectPayments::TEMPLATE => self::t('Bank-Transaktionen'),
            ...
            PageRenderer\TaxationStatutorySources::TEMPLATE => self::t('Taxation Legal Basis'),
...
if something has changed in the orchestra app.'),
            PageRenderer\DonationReceipts::TEMPLATE => self::t('Display the list of donation receipts asserted by our organization. Donation receipts can also be reviewed by visiting the finance folder.'),
            PageRenderer\Instruments::TEMPLATE => self::t('Display the list of instruments known by the data-base, possibly add new ones as needed.'),
            PageRenderer\InstrumentFamilies::TEMPLATE => self::t('Display the list of instrument families and add or change them as needed.'),
            ...
            PageRenderer\Invoices::TEMPLATE => self::t('Display a table with the sent-out invoices and support for issuing new invoices.'),
            ...
            PageRenderer\ProjectParticipantFields::TEMPLATE => self::t('Add additional data-fields to the instrumenation table for the project. This just add project-specific columns to the table like project fees, reimbursements etc. Do not get nervous: just try! Its not that difficult and helps to keep the data together inside one table!'),
            ...
            PageRenderer\ProjectAssociates::TEMPLATE => self::t('Detailed display of business partners or otherwise project related (legal) persons.'),
            PageRenderer\ProjectPayments::TEMPLATE => self::t('A table holding the various payments and reimbursements of participants, as well as bank transfers to external parties.'),
            PageRenderer\Projects::TEMPLATE => self::t('Overview over all known projects (start-page).'),
            PageRenderer\SepaBankAccounts::TEMPLATE => self::t('Display a table with the bank accounts of the project participants,
with the possibility to issued money transfers as well as debit-notes
to and from the registered bank accounts.'),
            PageRenderer\SepaBulkTransactions::TEMPLATE => self::t('A table holding all bulk bank-transactions issued from the orchestra-software.'),
            PageRenderer\TaxationStatutorySources::TEMPLATE => self::t('Taxation statutory sources table, used for invoicing and donation receipts.'),
            PageRenderer\TaxExemptionNotices::TEMPLATE => self::t('Tax exemption notices give the legal basis for donation receipts and omitting sales taxes in invoices.'),
          ],
        ],
