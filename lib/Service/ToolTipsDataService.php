...
This is a virtual folder giving direct access to stored copies -- probably scans of the real documents -- of notices of exemption from various tax-types, as issued on request by the respective tax authorities. The main overview table with additional information is accessible through the [%2$s table](%3$s).
