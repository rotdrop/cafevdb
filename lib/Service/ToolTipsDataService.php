      ...
      'templates' => [
        'navigation' => [
          'name' => [
            ...
            PageRenderer\ProjectPayments::TEMPLATE => self::t('Received Payments'),
...
if something has changed in the orchestra app.'),
            ...
            PageRenderer\ProjectPayments::TEMPLATE => self::t('A table holding the various payments of participants.'),
