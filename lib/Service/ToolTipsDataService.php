...
- it is to some extend possible to rename the entries and push back the changes
to the overview table of existing notices of exemption

- in order to do so the naming scheme must be strictly respected (no spaces,
