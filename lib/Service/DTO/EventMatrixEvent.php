...
class EventMatrixEvent extends \OCA\CAFEVDB\Toolkit\DTO\AbstractDTO
{
  ...
  public static function fromArray(array $data): self
  {
    ...
    return new self(
      ...
      deleted: is_string($deleted) ? CarbonImmutable::parse($deleted) : $deleted,
      description: $description,
      end: is_string($end) ? CarbonImmutable::parse($end) : $end,
      location: $location,
      projectId: $projectId,
      recurrenceId: $recurrenceId,
      sequence: $sequence,
      seriesStart: is_string($seriesStart) ? CarbonImmutable::parse($seriesStart) : $seriesStart,
      seriesUid: $seriesUid,
      start: is_string($start) ? CarbonImmutable::parse($start) : $start,
      summary: $summary,
      times: $times,
      uid: $uid,
      uri: $uri,
