...
class RenameMemberStatusParticipationStatus extends AbstractMigration
{
  ...
  SET pp.participation_status = IFNULL(pp.participation_status, m.default_participation_status)",
    ],
  ];
  ...
  {
    return $this->l->t('Rename member_status to the more neutral participation_status name.');
  }
