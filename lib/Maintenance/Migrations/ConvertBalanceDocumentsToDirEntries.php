...
use OCA\CAFEVDB\Exceptions\DatabaseMigrationException;
...
SELECT p.id,
  ...
  "folder"
FROM Projects p
LEFT JOIN ' . self::PROJECT_BALANCE_SUPPORTING_DOCUMENTS_TABLE . ' pb
...
SELECT
  ...
  pb.created,
  "folder"
FROM ' . self::PROJECT_BALANCE_SUPPORTING_DOCUMENTS_TABLE . ' pb
