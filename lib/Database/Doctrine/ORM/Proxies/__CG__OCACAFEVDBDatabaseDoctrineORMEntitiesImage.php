 ...
 */
class Image extends \OCA\CAFEVDB\Database\Doctrine\ORM\Entities\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'id', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'mimeType', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'width', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'height', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'md5', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'imageDataId', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'imageData', '' . "\0" . 'OCA\\CAFEVDB\\Database\\Doctrine\\ORM\\Entities\\Image' . "\0" . 'keys'];
        }
    ...
    public function setImageDataId(int $imageData = -1)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setImageDataId', [$imageData]);

        return parent::setImageDataId($imageData);
    }
    ...
    public function getImageDataId(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getImageDataId', []);

        return parent::getImageDataId();
    }
