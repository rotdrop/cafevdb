 ...
 */
#[ORM\Table(name: DatabaseTables::PROJECT_PARTICIPANTS_TABLE)]
...
class ProjectParticipant implements \ArrayAccess
{
  ...
  private Types\EnumParticipationStatus $participationStatus = Types\EnumParticipationStatus::REGULAR;
  ...
  public function __construct(?Musician $musician = null, ?Project $project = null)
  {
    ...
    $this->participationStatus = $musician
      ? $musician->getDefaultParticipationStatus()
  ...
  {
    $this->participationStatus = Types\EnumParticipationStatus::get($participationStatus);
