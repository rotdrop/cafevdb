...
#[ORM\Entity(repositoryClass: \OCA\CAFEVDB\Database\Doctrine\ORM\Repositories\EmailDraftsRepository::class)]
...
class EmailDraft implements \ArrayAccess
{
  ...
  /**
   * @var Collection<EmailAttachment>
   */
  #[ORM\OneToMany(targetEntity: EmailAttachment::class, mappedBy: 'draft', orphanRemoval: true)]
