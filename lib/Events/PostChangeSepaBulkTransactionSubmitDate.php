...
class PostChangeSepaBulkTransactionSubmitDate extends Event
{
   ...
   *
   * @param Entities\SepaBulkTransaction $entity Current entity with updated values.
   *
   ...
   *
   * @return Entities\SepaBulkTransaction
   */
  public function getEntity():Entities\SepaBulkTransaction
  {
    return $this->entity;
  }
   ...
   */
  public function getOldValue():?DateTimeInterface
  {
   ...
   * @return DateTimeInterface
   */
  public function getNewValue():?DateTimeInterface
  {
